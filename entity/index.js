...
EntityGenerator.prototype.files = function files() {
  ...
  this.template('../../app/templates/_app.js', 'app.js');
  this.template('models/_entity.js', 'models/' + this.name + '.js');
  this.template('routes/_entities.js', 'routes/' + pluralize(this.name) + '.js');
